...
namespace Timetable {
  ...
  export const createTable = <T = boolean>(init: () => T = (() => false) as any) => {
    const table: T[][] = [];
  ...
  export const toString = (value: boolean[][]) => {
    let str = "";
  ...
  export const toArray = (preferredTime: string) => {
    // "0,1,2,3,32,33"
