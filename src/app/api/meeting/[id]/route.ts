import { changeMeeting, connectDB, createPreferredTime, getMeetingInfo } from "@/helper/db";
...
export async function POST(request: Request, context: { params: any }) {
  ...
  await createPreferredTime(db, parseInt(context.params.id), data.name, data.preferredTime);
